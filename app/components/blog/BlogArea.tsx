            ...
            <div className="container">
                ...
                <div className="col-md-6 col-lg-4">
                  <div className="blog__item v2">
                    ...
                    <div className="blog-content">
                      ...
                      <h6 className="blog-title text-anime">
                ...
                <div className="col-md-6 col-lg-4">
                  <div className="blog__item v2">
                    ...
                    <div className="blog-content">
                      ...
                      <h6 className="blog-title text-anime">
                        <a href='blog-details.html'>
                          How to Design a High-Converting CRM Landing Page
                        </a>
                      </h6>
                      <p>
                        Etiam ullamcorper malasada elementum. In molestie
                ...
                <div className="col-md-6 col-lg-4">
                  <div className="blog__item v2">
                    ...
                    <div className="blog-content">
                      ...
                      <h6 className="blog-title text-anime">
                        <a href='blog-details.html'>
                          Best Practices for Writing CRM Landing Page Copy
                        </a>
                      </h6>
                      <p>
                        Etiam ullamcorper malasada elementum. In molestie
                ...
                <div className="col-md-6 col-lg-4">
                  <div className="blog__item v2">
                    ...
                    <div className="blog-content">
                      ...
                      <h6 className="blog-title text-anime">
                        <a href='blog-details.html'>
                          The Role of CTAs in CRM Landing Page Success
                        </a>
                      </h6>
                      <p>
                        Etiam ullamcorper malasada elementum. In molestie
              ...
              <div className="row row-padding-top">
                <div className="col-12">
                  <nav aria-label="pagination" className="pagination-area__nav">
